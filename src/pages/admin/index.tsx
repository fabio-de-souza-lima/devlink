  ...
  return(
    <div className="flex items-center flex-col min-h-screen pb-7 px-2">
      ...
      <form className="flex flex-col mt-8 mb-3 w-full max-w-xl" onSubmit={handleRegister}>
        ...
        <Input
         className=" mb-3 border border-gray-300 bg-white text-black p-2 rounded-md placeholder-gray-500"
        ...
        />
         ...
         <Input
         type="url"
         className="border border-gray-300 bg-white text-black p-2 rounded-md placeholder-gray-500"
